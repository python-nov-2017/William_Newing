...
def index():
    if 'gold' not in session:
        session['gold'] = 0
        session['activities'] = []
    return render_template("goldindex.html", gold=session['gold'], activities=session['activities'])
